            ...
            <div class="swiper-wrapper">
                @foreach($categories as $category)
                    ...
                    <a class="slider-category" href="{{route('category.post', $category->slug)}}">
                        <div class="blog-image"><img src="{{asset(Storage::disk('public')->url('category/slider/'.$category->image))}}" alt="{{$category->name}}"></div>
                ...
                @foreach($posts as $post)
                    ...
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <div class="blog-image"><img src="{{asset(Storage::disk('public')->url('post/'.$post->image))}}" alt="Blog Image"></div>

                            <a class="avatar" href="{{route('post.author', $post->user->username)}}"><img src="{{asset(Storage::disk('public')->url('profile/'.$post->user->image))}}" alt="Profile Image"></a>
